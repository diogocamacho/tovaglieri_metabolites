...
write.csv(t_log_abundance, file="./res/t_norm_log_abundance.csv")
...
#subset feed the subset of log_count (the one woth metabolites increased in H andM compared tor Pre) to the linearized model to calculate DE again
